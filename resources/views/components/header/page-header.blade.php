...
@php
    ...
    if ($siteContext && str_starts_with($routeName, 'sites.') && $routeName !== 'sites.index' && $routeName !== 'sites.create') {
        ...
        $pageTitle = match($routeName) {
            ...
            'sites.security.performance' => __('Performance'),
            'sites.security.site-control' => __('Site Control'),
            'sites.security.admin-ux' => __('Admin UX'),
            'sites.security.content-media' => __('Content & Media'),
            'sites.security.email' => __('Email'),
