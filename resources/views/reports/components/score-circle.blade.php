...
@php
    ...
    $palette = [
        'green'  => ['fill' => '#10b981', 'text' => '#059669'],
        'orange' => ['fill' => '#f59e0b', 'text' => '#d97706'],
        'red'    => ['fill' => '#ef4444', 'text' => '#dc2626'],
        'na'     => ['fill' => '#94a3b8', 'text' => '#94a3b8'],
    ];
    $c = $palette[$colorKey];
    $pct = $score !== null ? min($score, 100) : 0;

    $numSize   = $isLg ? '26pt' : '18pt';
...
<div style="text-align: center;">
    ...
    <div style="font-size: {{ $labelSize }}; color: #94a3b8; margin-bottom: 5px;">/ 100</div>
    <div style="background: #e2e8f0; height: {{ $barH }}; width: {{ $barW }}; {{ !$isLg ? 'margin: 0 auto;' : '' }}">
