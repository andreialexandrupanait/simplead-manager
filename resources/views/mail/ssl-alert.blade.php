        ...
        <div class="card">
            <div class="header">
                <h1 style="margin: 0 0 8px; font-size: 20px;">
                    ...
                    @elseif($alertType === 'expiring_soon')
            ...
            <div class="details">
                <table width="100%" cellpadding="0" cellspacing="0">
                    ...
                    <tr>
                        ...
                        <td style="padding: 12px 0; border-bottom: 1px solid #f3f4f6; color: #1f2937; font-size: 14px; font-weight: 500;">{{ $certificate->domain }}</td>
                    </tr>
                    <tr>
                        <td style="padding: 12px 0; border-bottom: 1px solid #f3f4f6; color: #6b7280; font-size: 14px;">Issuer</td>
                        <td style="padding: 12px 0; border-bottom: 1px solid #f3f4f6; color: #1f2937; font-size: 14px; font-weight: 500;">{{ $certificate->issuer ?? 'Unknown' }}</td>
                    </tr>
                    <tr>
                        <td style="padding: 12px 0; border-bottom: 1px solid #f3f4f6; color: #6b7280; font-size: 14px;">Expires</td>
                        <td style="padding: 12px 0; border-bottom: 1px solid #f3f4f6; color: #1f2937; font-size: 14px; font-weight: 500;">{{ $certificate->expires_at?->format('M d, Y H:i:s') ?? 'Unknown' }} UTC</td>
                    </tr>
                    <tr>
                        <td style="padding: 12px 0; border-bottom: 1px solid #f3f4f6; color: #6b7280; font-size: 14px;">Days Remaining</td>
                        <td style="padding: 12px 0; border-bottom: 1px solid #f3f4f6; color: #1f2937; font-size: 14px; font-weight: 500;">{{ $certificate->days_remaining ?? 'N/A' }}</td>
                    </tr>
                    @if($certificate->error_message)
                    <tr>
                        <td style="padding: 12px 0; border-bottom: 1px solid #f3f4f6; color: #6b7280; font-size: 14px;">Error</td>
                        <td style="padding: 12px 0; border-bottom: 1px solid #f3f4f6; color: #dc2626; font-size: 14px; font-weight: 500;">{{ $certificate->error_message }}</td>
                    </tr>
                    @endif
                </table>
            </div>
