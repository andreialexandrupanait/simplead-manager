...
<x-ui.card :padding="false">
    ...
    <div class="flex items-center justify-between border-b border-gray-100 px-4 py-3">
        ...
        @if($isConnected)
            <a href="{{ route('sites.search-console', $site) }}" class="text-xs text-purple-600 hover:text-purple-700">
                View Details →
            </a>
        @endif
    </div>
    ...
    <div class="p-4">
        ...
        @else
            <div class="rounded-lg border border-dashed border-gray-200 p-4 text-center">
                ...
                <a href="{{ route('sites.search-console', $site) }}" class="mt-1 inline-block text-xs text-purple-600 hover:text-purple-700">
