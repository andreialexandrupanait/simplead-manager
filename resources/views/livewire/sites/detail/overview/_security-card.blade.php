...
<x-ui.card :padding="false" class="flex flex-col">
    ...
    <div class="flex items-center justify-between border-b border-gray-100 px-3 py-2.5">
        ...
        <a href="{{ route('sites.security', $site) }}" class="text-xs text-purple-600 hover:text-purple-700">
            View Details →
        </a>
    </div>
    ...
    <div class="flex flex-1 flex-col p-3">
        ...
        @else
            <div class="py-2 text-center">
                ...
                <a href="{{ route('sites.security', $site) }}" class="mt-2 inline-block text-xs text-purple-600 hover:text-purple-700">
                    Enable Security →
                </a>
            </div>
        @endif
