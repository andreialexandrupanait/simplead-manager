    ...
    <div class="flex items-center justify-between border-b border-gray-100 px-3 py-2.5">
        <div class="flex items-center gap-2">
            <div class="flex h-8 w-8 items-center justify-center rounded-lg bg-pink-100">
                <svg aria-hidden="true" class="h-4 w-4 text-pink-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        @if($site->client)
            ...
            <div class="flex-1 space-y-1.5">
                @if($site->client->email)
                    <a href="mailto:{{ $site->client->email }}" class="flex items-center gap-2 text-xs text-accent-600 hover:text-accent-700 hover:underline truncate">
