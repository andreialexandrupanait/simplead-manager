<div>
    ...
    <div class="space-y-6">
        ...
        <form wire:submit="savePreferences">
            <x-ui.card>
                <h3 class="text-base font-semibold text-gray-900 mb-4">{{ __('Notification Preferences') }}</h3>
                <div class="space-y-4">
            ...
            <x-ui.card class="mt-6">
                <h3 class="text-base font-semibold text-gray-900 mb-4">{{ __('Quiet Hours') }}</h3>
                <p class="text-sm text-gray-500 mb-4">{{ __('Suppress notifications during specified hours.') }}</p>
    ...
    <x-ui.card class="mt-6">
        <div class="flex items-center justify-between mb-4">
            <div>
                ...
                <p class="text-sm text-gray-500">{{ __('Customize notification messages per event type. Use placeholders:') }} <code class="text-xs bg-gray-100 px-1 rounded">{site_name}</code>, <code class="text-xs bg-gray-100 px-1 rounded">{site_url}</code>, <code class="text-xs bg-gray-100 px-1 rounded">{details}</code></p>
            </div>
    ...
    {{-- Escalation Rules --}}
    <x-ui.card class="mt-6">
        <h3 class="text-base font-semibold text-gray-900 mb-2">{{ __('Escalation Rules') }}</h3>
        <p class="text-sm text-gray-500 mb-4">{{ __("If a critical alert isn't acknowledged within the delay, escalate to another channel.") }}</p>
