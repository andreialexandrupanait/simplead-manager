...
class SeoPage extends Model
{
    ...
    {
        return ['h1_tags' => 'array', 'heading_structure' => 'array', 'structured_data_types' => 'array', 'og_tags' => 'array', 'twitter_tags' => 'array', 'meta' => 'array', 'is_self_canonical' => 'boolean', 'is_indexable' => 'boolean', 'in_sitemap' => 'boolean', 'blocked_by_robots' => 'boolean', 'has_viewport_meta' => 'boolean'];
    }
    ...
    {
        return $query->where('inbound_internal_links', 0)->where('status_code', 200);
    }
}
