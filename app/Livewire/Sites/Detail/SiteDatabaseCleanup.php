...
class SiteDatabaseCleanup extends Component
{
    ...
    public function runCleanup(): void
    {
        $options = [
            ...
            'trashed_posts' => $this->cleanTrashPosts,
            'spam_comments' => $this->cleanSpamComments,
            'trashed_comments' => $this->cleanTrashComments,
            'expired_transients' => $this->cleanTransients,
            'orphaned_postmeta' => $this->cleanOrphanedMeta,
            'orphaned_commentmeta' => $this->cleanOrphanedMeta,
            'orphaned_usermeta' => $this->cleanOrphanedMeta,
            'orphaned_termmeta' => $this->cleanOrphanedMeta,
