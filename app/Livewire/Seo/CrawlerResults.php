...
class CrawlerResults extends Component
{
    ...
    public function tableColumns(): array
    {
        return match ($this->dataTab) {
            ...
            'content' => ['url', 'title', 'word_count', 'readability_score', 'h1_count', 'h2_count', 'images_count', 'status_code'],
            'images' => ['page_url', 'url', 'alt', 'width', 'height'],
            'canonicals' => ['url', 'title', 'canonical_url', 'canonical_self_ref', 'status_code'],
            'directives' => ['url', 'title', 'meta_robots', 'x_robots_tag', 'status_code'],
