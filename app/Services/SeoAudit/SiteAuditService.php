...
class SiteAuditService
{
    public function startAudit(Site $site, string $trigger = 'manual'): SeoAudit
    {
        ...
        if (! $monitor) {
            $monitor = SeoMonitor::create(['site_id' => $site->id, 'is_active' => false, 'interval_minutes' => 10080]);
        }
    ...
    public function hasRunningAudit(Site $site): bool
    {
        return $site->seoAudits()->running()->exists();
    }
}
